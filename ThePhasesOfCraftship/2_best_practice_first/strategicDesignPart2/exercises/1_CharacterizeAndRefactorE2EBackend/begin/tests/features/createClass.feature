Feature: Create Class
  ...
  Scenario: Fail to create a class with an already existing name
    Given There is a class named "Math"
    When I send a request to create a class with the existing class name
